...
self.addEventListener('install', event => {
  console.log('[MedWard SW] Installing v2.0.5-sdk-fix');
  event.waitUntil(
...
self.addEventListener('activate', event => {
  console.log('[MedWard SW] Activating v2.0.5-sdk-fix');
  event.waitUntil(
    caches.keys()
...
console.log('[MedWard SW] Loaded v2.0.5-sdk-fix');
